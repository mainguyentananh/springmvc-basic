...
@Entity
@Table(name = "Page_Token")
public class Page_Token implements java.io.Serializable {
	...
	public Page_Token(Integer id, String id_page, String name_page, String link_page, String token) {
		this.id = id;
