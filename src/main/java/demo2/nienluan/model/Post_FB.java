...
@Entity
@Table(name = "Post_FB")
public class Post_FB implements java.io.Serializable{
	...
	public Post_FB(Integer id, String id_page, String name_page, String link_page, String access_token, String content,
